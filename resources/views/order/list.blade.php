        ...
        <div class="kt-portlet__body"  style="">
            <div class="kt-portlet__content">
                <div class="form-group row">
                    <div class="col-lg-4">
                        <label>status:</label>
                        <select class="form-control order-filter" name="status" >
                    ...
                    <div class="col-lg-4">
                        <label>Date:</label>
                        <input type="date" name="date" class="form-control order-filter">
                    </div>
                    {{-- <div class="col-lg-4">
                        <button class="btn btn-default btn-md">Clear Filter</button>
                    </div> --}}
                </div>
            </div>
        </div>
